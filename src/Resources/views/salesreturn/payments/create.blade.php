...
@section('title', __('shopboss::shopboss.createSaleReturnPayment'))

@push('buttons')
    <a class="btn btn-sm btn-isotope fw-bold" href="{{ route('sale-returns.index') }}">{{ __('shopboss::shopboss.back') }}</a>
@endpush
            ...
            <form action="{{ route('sale-return-payments.store') }}" method="post" class="row">
                ...
                <div class="col-12">
                    <div class="my-5 text-center">
                        <button type="submit" class="btn btn-sm bg-isotope text-white">{{ __('shopboss::shopboss.createSaleReturnPayment') }}
