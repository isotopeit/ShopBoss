...
@section('title', __('shopboss::shopboss.editRole'))
            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="permissions">
                                    {{ __('shopboss::shopboss.permissions') }} <span class="text-danger">*</span>
                                </label>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="role_access" name="permissions[]"
                                                               value="role_access" {{ $role->hasPermissionTo('role_access') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="role_access">Role Access</label>
                                                    </div>
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="role_create" name="permissions[]"
                                                               value="role_create" {{ $role->hasPermissionTo('role_create') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="role_create">Role Create</label>
                                                    </div>
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="role_update" name="permissions[]"
                                                               value="role_update" {{ $role->hasPermissionTo('role_update') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="role_update">Role Update</label>
                                                    </div>
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="role_update" name="permissions[]"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="user_access" name="permissions[]"
                                                               value="user_access" {{ $role->hasPermissionTo('user_access') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="user_access">User Access</label>
                                                    </div>
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="user_create" name="permissions[]"
                                                               value="user_create" {{ $role->hasPermissionTo('user_create') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="user_create">User Create</label>
                                                    </div>
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="user_update" name="permissions[]"
                                                               value="user_update" {{ $role->hasPermissionTo('user_update') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="user_update">User Update</label>
                                                    </div>
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="user_delete" name="permissions[]"
                                                               value="user_delete" {{ $role->hasPermissionTo('user_delete') ? 'checked' : '' }}>
                    ...
                    <div class="form-group float-right">
                        <button type="submit" class="btn btn-primary">{{ __('shopboss::shopboss.updateRole') }} <i class="bi bi-check"></i>
                        </button>
                    </div>
                </form>
            </div>
