    ...
    <ul class="c-sidebar-nav-dropdown-items">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('products.index') ? 'c-active' : '' }}" href="{{ route('products.index') }}">
                <i class="c-sidebar-nav-icon bi bi-journals" style="line-height: 1;"></i> {{ __('Product Stock') }}
            </a>
        </li>
        @can('print_barcodes')
           <li class="c-sidebar-nav-item">
...
@can('access_adjustments')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('adjustments.*') ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class="c-sidebar-nav-icon bi bi-clipboard-check" style="line-height: 1;"></i> {{ __('Adjustments') }}
        </a>
        <ul class="c-sidebar-nav-dropdown-items">
...
@can('access_customers|access_suppliers')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('customers.*') || request()->routeIs('suppliers.*') ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class="c-sidebar-nav-icon bi bi-people" style="line-height: 1;"></i> {{ __('People') }}
        </a>
        <ul class="c-sidebar-nav-dropdown-items">
...
@can('access_user_management')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('roles*') ? 'c-show' : '' }}">
        ...
        <ul class="c-sidebar-nav-dropdown-items">
            ...
            @can('show_role_list')
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('roles*') ? 'c-active' : '' }}" href="/authorization/roles">
                    <i class="c-sidebar-nav-icon bi bi-key" style="line-height: 1;"></i> {{ __('Authorization') }}
                </a>
            </li>
            @endcan
        </ul>
...
@can('access_currencies|access_settings|access_branch')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('currencies*') ? 'c-show' : '' }}">
        ...
        <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="{{ route('branches.index') }}">
                    <i class="c-sidebar-nav-icon bi bi-shop" style="line-height: 1;"></i> {{ __('Branch') }}
                </a>
            </li>
        </ul>
        @endcan
        ...
        <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="{{ route('currencies.index') }}">
