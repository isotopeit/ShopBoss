...
@section('title', __('shopboss::shopboss.editPurchasePayment'))

@push('buttons')
<a class="btn btn-sm btn-isotope fw-bold" href="{{ route('purchase-payments.index', 'purchase_id='.$payment->purchase->id) }}">{{ __('shopboss::shopboss.back') }}</a>
@endpush
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <form action="{{ route('purchase-payments.update', $payment->id) }}" method="post" class="row">
                @csrf
                @method('PUT')
                <div class="col-md-6">
                    <div class="mb-4">
                ...
                <div class="col-md-4">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-sm" value="{{ $payment->purchase->due_amount }}" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-4">
                ...
                <div class="col-12">
                    <div class="my-5 text-center">
                        <button type="submit" class="btn btn-sm bg-isotope text-white">
                            {{ __('shopboss::shopboss.updatePurchasePayment') }}
