...
@section('title', __('shopboss::shopboss.purchasePayments'))

@push('buttons')
<a class="btn btn-sm btn-isotope fw-bold" href="{{ route('purchases.index') }}">{{ __('shopboss::shopboss.back') }}</a>
@endpush
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h2>{{ __('shopboss::shopboss.purchases') }} #{{ $purchase->reference }}</h2>
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    <a title="{{ __('shopboss::shopboss.edit') }}"
                                        ...
                                        href="{{ route('purchase-payments.edit', [$payment->id]) }}">
                                        <i class="fas fa-edit ms-1"></i>
                                    </a>
                                    <form action="{{ route('purchase-payments.destroy', $payment->id) }}"
                                        method="post">
                                        @method('delete') @csrf
