...
@section('title', __('shopboss::shopboss.createPurchasePayment'))
            ...
            <form action="{{ route('purchase-payments.store') }}" method="post" class="row">
                ...
                <div class="col-12">
                    <div class="my-5 text-center">
                        <button type="submit" class="btn btn-sm bg-isotope text-white">{{ __('shopboss::shopboss.createPurchasePayment') }}
