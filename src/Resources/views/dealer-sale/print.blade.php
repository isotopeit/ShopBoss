...
<head>
    ...
    <title>{{ __('shopboss::shopboss.saleDetails') }}</title>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div style="text-align: center;margin-bottom: 25px;">
                    <img width="180" src="{{ asset(settings()->logo) ?? public_path('images/logo-dark.png') }}" alt="Company Logo">
                    <h4 style="margin-bottom: 20px;">
                        <span>{{ __('shopboss::shopboss.reference') }}::</span> <strong>{{ $sale->reference }}</strong>
                    </h4>
                </div>
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-xs-4 mb-3 mb-md-0">
                                <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">
                                    {{ __('shopboss::shopboss.customerInfo') }}:</h4>
                            ...
                            <div class="col-xs-4 mb-3 mb-md-0">
                                ...
                                <div>{{ __('shopboss::shopboss.date') }}: {{ \Carbon\Carbon::parse($sale->date)->format('d M, Y') }}
                                </div>
                                <div>
                            ...
                            <div class="col-xs-4 col-xs-offset-8">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="left"><strong>{{ __('shopboss::shopboss.tax') }}
