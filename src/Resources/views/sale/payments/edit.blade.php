...
@push('buttons')
    <a class="btn btn-sm btn-isotope fw-bold" href="{{ route('sale-payments.index', 'sale_id='.$payment->sale->id) }}">{{ __('Back') }}</a>
@endpush
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <form action="{{ route('sale-payments.update', $payment->id) }}" method="post" class="row">
                @csrf
                @method('PUT')
                <div class="col-md-6">
                    <div class="mb-4">
                ...
                <div class="col-md-4">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-sm" value="{{ $payment->sale->due_amount }}" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-4">
