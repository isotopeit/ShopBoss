...
@section('title', __('shopboss::shopboss.editPurchaseReturnPayment'))

@push('buttons')
<a class="btn btn-sm btn-isotope fw-bold" href="{{ route('purchase-return-payments.index', 'purchase_return_id='.$payment->purchaseReturn->id) }}">{{ __('shopboss::shopboss.back') }}</a>
@endpush
                ...
                <div class="col-12">
                    <div class="my-5 text-center">
                        <button type="submit" class="btn btn-sm bg-isotope text-white">
                            {{ __('shopboss::shopboss.updatePurchaseReturnPayment') }}
